      ...
      <div class="container">
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-top">
            ...
            <a href="#" class="logo">
              <img src="{{ asset('images/logo.png') }}" alt="HostelConnect logo">
            </a>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="{{(request()->route()->getName()=='home#about')?'active':''}}" class="navbar-link" data-nav-link>About</a>
              </li>

              <li>
                <a href="{{(request()->route()->getName()=='home#service')?'active':''}}" class="navbar-link" data-nav-link>Service</a>
              </li>
    ...
    <article>
	  ...
	  <section class="property" id="property">
        <div class="container">
          ...
          @foreach($latestHostel as $hostels)
          <li>
            <div class="property-card">
                <div class="card-content">
                    <div class="card-price">
                        <strong>KSH{{ number_format($hostels->rent, 2) }}</strong>/Month
                    </div>
                    <h3 class="h3 card-title">
                    {{ $hostels->name }}
                  </h3>
                    ...
                    <ul class="card-list">
                        <li class="card-item">
                            <strong>{{ $hostels->vacant_beds }}</strong>
                            <ion-icon name="bed-outline"></ion-icon>
                            <span>Bedrooms</span>
                        </li>
                        <a href="{{ route('hostels.show', ['id' => $hostels->H_id]) }}" class="btn btn-primary">View Details</a>        
                    </ul>
                               </div>
            </div>
            <div class="card-footer">
                  ...
                  <div class="card-author">
                    ...
                    <div>
                      <p class="author-name">
                        <a href="#">{{$hostels->user->first_name }}</a>
                      </p>
