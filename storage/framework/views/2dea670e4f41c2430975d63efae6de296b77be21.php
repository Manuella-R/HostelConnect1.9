    ...
    <?php $__currentLoopData = $hostelOwners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="user-card">
            ...
            <div class="user-card-body" id="body-<?php echo e($owner->id); ?>">
                ...
                <div class="email">Email: <?php echo e($owner->email); ?></div>
                <div class="phone_number">Phone number: <?php echo e($owner->phone_number); ?></div>
                <?php if($owner->hostel): ?>
                            <div class="establishment_name">Hostel: <?php echo e($owner->hostel->name); ?></div>
                            <div class="address">Address: <?php echo e($owner->hostel->address); ?></div>
                        <?php endif; ?>
                <div class="actions">
