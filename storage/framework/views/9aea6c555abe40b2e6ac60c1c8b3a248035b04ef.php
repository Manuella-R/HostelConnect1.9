        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="<?php echo e((request()->route()->getName()=='home#property')?'active':''); ?>" class="navbar-link" data-nav-link>Property</a>
              </li>
          ...
          <li>
            <div class="property-card">
                <div class="card-content">
                    ...
                    <a href="<?php echo e(route('hostels.show', ['id' => $hostels->H_id])); ?>" class="btn btn-primary">View Details</a>                    </div>
            </div>
